...
That makes it plain and simple, if a software engineer is planning on developing software, the should adhere to the Software Engineering Code of Ethics, and it applies to them. As I said before, the original creator of BitTorrent is a Software Engineer, and thus the Software Engineering Code of Ethics is applicable.

There is an issue with the Software Engineering Code of Ethics though. The code focuses almost entirely on the process of creating software instead of deciding whether the actual act and final product are ethical. For example, a software engineer could create a trajectory calculation system in a purely ethical manor. From the preamble to section 8.09, they could follow to the very last letter. The problem though, is that once they hand off their trajectory software to a client. That client can still build a missile in their garage, and then use the trajectory program to guide the missile into a children's school.
