...
The Software Engineering Code of Ethics agrees with Floridi. In Section 3.14, it says that all software engineers should work to ``maintain the integrity of data'' \cite[3.14]{secode}. ``BitTorrent is a protocol for distributing files'' \cite{btspec}.
